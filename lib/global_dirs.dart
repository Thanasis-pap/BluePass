...
export 'package:passwordmanager/tools/biometric_helper.dart';
...
export 'package:passwordmanager/pages/password.dart';
export 'package:passwordmanager/pages/card.dart';
export 'package:passwordmanager/pages/edit_password.dart';
export 'package:passwordmanager/user_database_enc.dart';
export 'package:passwordmanager/pages/edit_card.dart';
export 'package:passwordmanager/data_enc.dart';
export 'package:passwordmanager/tools/secure_storage.dart';
export 'package:passwordmanager/tools/aes_helper.dart';
export 'package:passwordmanager/pages/cards_list.dart';
export 'package:passwordmanager/pages/passwords_list.dart';
export 'package:passwordmanager/tools/recent_helper.dart';

class Global {
  static List<Map<String, dynamic>?> recentItems = [];
  static List<Map<String, dynamic>?> favorItems = [];
  static double fontSize = 18;
  static bool noPassword = false;
